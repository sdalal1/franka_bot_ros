    ...
    def timer_callback(self):
        ...
        if self.state == State.TRANSFORMING:
            ...
            try:
                ...
                self.robot_to_brush = [-t.transform.translation.x, -t.transform.translation.y, t.transform.translation.z]
            ...
            try:
                ...
                self.robot_to_palete = [-t.transform.translation.x, -t.transform.translation.y, t.transform.translation.z,]
